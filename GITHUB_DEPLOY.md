...
2. **Prévia navegável do GitHub Pages** — `github-pages/`. É estática e existe para apresentação pública dentro do GitHub Pages.
...
4. Abra **Actions** e confirme a execução de `Deploy GitHub Pages Preview`.
